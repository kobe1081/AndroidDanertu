...
public class BaseMessage {
    ...
    public Object getResult(String modelName) throws Exception {
        Object model = this.resultMap.get(getModelName(modelName));
    ...
    public ArrayList<? extends BaseModel> getResultList(String modelName) throws Exception {
        ArrayList<? extends BaseModel> modelList = this.resultList.get(getModelName(modelName));
        // catch null exception
    ...
    public void setResult(String result) throws Exception {
        ...
        if (result.length() > 0) {
            ...
            while (it.hasNext()) {
                ...
                String modelClassName = "com.danertu.entity." + modelName;
