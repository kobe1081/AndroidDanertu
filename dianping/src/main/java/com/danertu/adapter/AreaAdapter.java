...
public class AreaAdapter extends BaseAdapter {
	...
	private ArrayList<ArrayList<String>> getData()
	{
		...
		ArrayList<String> quanbu = new ArrayList<>();
		quanbu.add("全部地区");
		quanbu.add("全部地区 ");
		data.add(quanbu);

		ArrayList<String> hongkou = new ArrayList<>();
		hongkou.add("全部地区");
		hongkou.add("虹口区");
		hongkou.add("海宁路/七浦路");
		...
		ArrayList<String> zhabei = new ArrayList<>();
		zhabei.add("全部地区");
		zhabei.add("闸北区");
		zhabei.add("大宁大区");
		zhabei.add("北区汽车站");
		...
		ArrayList<String> xuhui = new ArrayList<>();
		xuhui.add("全部地区");
		xuhui.add("徐汇区");
		xuhui.add("衡山路");
		xuhui.add("音乐学院");
		...
		ArrayList<String> changning = new ArrayList<>();
		changning.add("全部地区");
		changning.add("长宁区");
		changning.add("天山");
		...
		ArrayList<String> yangpu = new ArrayList<>();
		yangpu.add("全部地区");
		yangpu.add("杨浦区");
		yangpu.add("五角场");
		yangpu.add("控江地区");
		...
		ArrayList<String> qingpu = new ArrayList<>();
		qingpu.add("全部地区");
		qingpu.add("青浦区");
		qingpu.add("朱家角");
		data.add(qingpu);

		ArrayList<String> songjiang = new ArrayList<>();
		songjiang.add("全部地区");
		songjiang.add("松江区");
		songjiang.add("松江镇");
		songjiang.add("九亭");
		...
		ArrayList<String> baoshan = new ArrayList<>();
		baoshan.add("全部地区");
		baoshan.add("宝山区");
		baoshan.add("大华大区");
		baoshan.add("庙行镇");
		...
		ArrayList<String> pudong = new ArrayList<>();
		pudong.add("全部地区");
		pudong.add("康桥/周浦");
		pudong.add("陆家嘴");
		pudong.add("世纪公园");
