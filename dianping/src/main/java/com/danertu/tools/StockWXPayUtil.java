 ...
 * 2018年1月4日
 * @author huangyeliang
 * 有关囤货功能（仓库）的微信支付功能都调用此类
 * 更换了服务器异步通知地址
 */
public class StockWXPayUtil {
    private final String TAG = getClass().getSimpleName();
    private IWXAPI msgApi = null;

    public StockWXPayUtil(Context context) {
        super();
...
//			return new String(xmlstring.getBytes(), "ISO8859-1");
    ...
    public PayReq genPayReq(String prepayId) {
        ...
        Logger.e("test", "genPayReq: signParams" + signParams);
        Logger.e("test", "genPayReq: sign=" + req.sign);
