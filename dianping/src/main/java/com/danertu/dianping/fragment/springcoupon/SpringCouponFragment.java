 ...
 * 下单页面返回至下单页面
 */
public class SpringCouponFragment extends NewBaseFragment<SpringCouponContact.SpringCouponView, SpringCouponPresenter> implements SpringCouponContact.SpringCouponView, XListView.IXListViewListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    @Override
    public SpringCouponPresenter initPresenter() {
        return new SpringCouponPresenter(context);
    }
