 ...
 * 过期
 */
public class CouponExpiredFragment extends NewBaseFragment<CouponExpiredContact.CouponExpiredView, CouponExpiredPresenter> implements CouponExpiredContact.CouponExpiredView, XListView.IXListViewListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    @Override
    public CouponExpiredPresenter initPresenter() {
        return new CouponExpiredPresenter(context);
    }
    ...
    public void notifyChange(int listSize, String totalCount) {
        ...
        if (listener != null) {
            listener.countCallBack(1, totalCount);
        }
        if (listSize > 0) {
            swipeRefresh.setEnabled(false);
...
//            bitmapDown.setWidth(dp12);
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            holder.tvMyCouponUse.setVisibility(View.GONE);
