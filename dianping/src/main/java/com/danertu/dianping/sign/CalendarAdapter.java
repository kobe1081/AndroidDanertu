...
public class CalendarAdapter extends BaseAdapter {
    ...
    public HashMap<Integer, Boolean> signMap = new HashMap<>();//哪些天是已经签到的
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView signText = (TextView) convertView.findViewById(R.id.signText);
...
//			textView.setTextColor(Color.WHITE);
//		}
        if (signMap.containsKey(position)) {
    ...
    public void getCalendar(int year, int month) {
        ...
        Logger.d("DAY", isLeapyear + " ======  " + daysOfMonth + "  ============  " + dayOfWeek + "  =========   " + lastDaysOfMonth);
        getweek(year, month);
    }
...
//			}
            if (i < dayOfWeek) {  //前一个月
                ...
                //这一天是否签到
                String key = year + "-" + month + "-" + (i - dayOfWeek + 1);
                String dayStr = seference.getPreferenceData(seference.signFileName, key, "");
                if (!TextUtils.isEmpty(dayStr) && !signMap.containsKey(i)) {
                    signMap.put(i, true);
                }
        ...
        String abc = "";
        for (String aDayNumber : dayNumber) {
            abc = abc + aDayNumber + ":";
        }
        Logger.d("DAYNUMBER", abc);
