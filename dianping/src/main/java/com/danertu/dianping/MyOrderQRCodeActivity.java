...
//    private String tabWeightName[] = {"全部", "待付款", "待发货", "待收货", "待评价"};
    ...
    /**
     * 是否需要初始化myOrderDataQRCode
     * 从ProductDetailWeb跳转过来的是不需要初始化myOrderDataQRCode的，此时不能给myOrderDataQRCode设置LoadListener，否则空指针
     */
...
//        setTopPadding(root,getStatusBarHeight());
        ...
        //myOrderDataQRCode，不需要设置监听，否则空指针
...
//        tvTabStr.setText(tabWeightName[tabIndex]);
    ...
    public static class MyHandler extends Handler {
        ...
        public MyHandler(MyOrderQRCodeActivity act) {
