...
public abstract class QuickActionWidget extends PopupWindow {
    ...
    public QuickActionWidget(Context paramContext) {
         ...
         *
         */
        WindowManager localWindowManager = (WindowManager) this.mContext.getSystemService(Context.WINDOW_SERVICE);
        DisplayMetrics metrics = new DisplayMetrics();
        localWindowManager.getDefaultDisplay().getMetrics(metrics);
...
//    }
    ...
    private void showArrow() {
        ...
        if (this.mIsOnTop) {
            localView3.setVisibility(View.VISIBLE);
            localView4.setVisibility(View.INVISIBLE);
        } else {
            localView3.setVisibility(View.INVISIBLE);
            localView4.setVisibility(View.VISIBLE);
        }
    }
    ...
    public interface OnQuickActionClickListener {
        void onQuickActionClicked(QuickActionWidget paramQuickActionWidget, int paramInt);
    }
}
